...
namespace OpenNest.Forms
{
    public class MachineConfigForm : Form
    {
        ...
        public MachineConfigForm(IDataProvider provider)
        {
            ...
            treeButtonPanel.Controls.AddRange(
                new Control[]
                {
                    addMachineButton,
                    removeMachineButton,
        ...
        private void LoadTree()
        {
            ...
            foreach (var summary in _provider.GetMachines())
            {
                ...
                foreach (var material in machine.Materials)
                {
                    ...
                    {
                        var thickNode = new TreeNode(thickness.Value.ToString("0.####"))
                        {
                            Tag = thickness,
                        };
        ...
        private void ShowMachineDetails(MachineConfig machine)
        {
            ...
            AddField(
                ...
                ref row,
                "Type:",
                CreateEnumCombo(machine.Type, v => machine.Type = v)
            );
            AddField(
                layout,
                ref row,
                "Units:",
                CreateEnumCombo(machine.Units, v => machine.Units = v)
            );
        ...
        private void ShowMaterialDetails(MaterialConfig material)
        {
            ...
            AddField(
                ...
                ref row,
                "Name:",
                CreateTextBox(material.Name, v => material.Name = v)
            );
            AddField(
                layout,
                ref row,
                "Grade:",
                CreateTextBox(material.Grade, v => material.Grade = v)
            );
            AddField(
                layout,
                ref row,
                "Density:",
                CreateNumericBox(material.Density, v => material.Density = v, 4)
            );
        ...
        private void ShowThicknessDetails(ThicknessConfig thickness)
        {
            ...
            AddField(
                ...
                ref row,
                "Thickness:",
                CreateNumericBox(thickness.Value, v => thickness.Value = v, 4)
            );
            AddField(
                layout,
                ref row,
                "Kerf:",
                CreateNumericBox(thickness.Kerf, v => thickness.Kerf = v, 4)
            );
            AddField(
                layout,
                ref row,
                "Assist Gas:",
                CreateTextBox(thickness.AssistGas, v => thickness.AssistGas = v)
            );
            ...
            AddField(
                ...
                ref row,
                "Type:",
                CreateTextBox(thickness.LeadIn.Type, v => thickness.LeadIn.Type = v)
            );
            AddField(
                layout,
                ref row,
                "Length:",
                CreateNumericBox(thickness.LeadIn.Length, v => thickness.LeadIn.Length = v, 4)
            );
            AddField(
                layout,
                ref row,
                "Angle:",
                CreateNumericBox(thickness.LeadIn.Angle, v => thickness.LeadIn.Angle = v, 1)
            );
            AddField(
                layout,
                ref row,
                "Radius:",
                CreateNumericBox(thickness.LeadIn.Radius, v => thickness.LeadIn.Radius = v, 4)
            );
            ...
            AddField(
                ...
                ref row,
                "Type:",
                CreateTextBox(thickness.LeadOut.Type, v => thickness.LeadOut.Type = v)
            );
            AddField(
                layout,
                ref row,
                "Length:",
                CreateNumericBox(thickness.LeadOut.Length, v => thickness.LeadOut.Length = v, 4)
            );
            AddField(
                layout,
                ref row,
                "Angle:",
                CreateNumericBox(thickness.LeadOut.Angle, v => thickness.LeadOut.Angle = v, 1)
            );
            AddField(
                layout,
                ref row,
                "Radius:",
                CreateNumericBox(thickness.LeadOut.Radius, v => thickness.LeadOut.Radius = v, 4)
            );
            ...
            AddField(
                ...
                "Part Clearance:",
                CreateNumericBox(
                    thickness.CutOff.PartClearance,
                    v => thickness.CutOff.PartClearance = v,
                    4
                )
            );
            AddField(
                ...
                "Overtravel:",
                CreateNumericBox(
                    thickness.CutOff.Overtravel,
                    v => thickness.CutOff.Overtravel = v,
                    4
                )
            );
            AddField(
                ...
                "Min Segment:",
                CreateNumericBox(
                    thickness.CutOff.MinSegmentLength,
                    v => thickness.CutOff.MinSegmentLength = v,
                    4
                )
            );
            AddField(
                ...
                ref row,
                "Direction:",
                CreateTextBox(thickness.CutOff.Direction, v => thickness.CutOff.Direction = v)
            );
        ...
        private static ComboBox CreateEnumCombo<T>(T currentValue, Action<T> setter)
            where T : struct, Enum
        {
        ...
        {
            if (_tree.SelectedNode?.Tag is not MachineConfig machine)
                return;
            if (
                MessageBox.Show(
        ...
        {
            if (_tree.SelectedNode?.Tag is not MaterialConfig material)
                return;
            if (_currentMachine is null)
                return;
        ...
        private void AddThickness_Click(object sender, EventArgs e)
        {
            ...
            if (material is null || _currentMachine is null)
                return;
        ...
        {
            if (_tree.SelectedNode?.Tag is not ThicknessConfig thickness)
                return;
